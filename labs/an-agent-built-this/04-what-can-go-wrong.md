...
*Two problems, one root cause: an agent with no guardrails. It shipped a
vulnerable image **and** could read every secret you own.*
...
| Agent reads everything | **Docker Sandboxes** (microVM, governed network/fs/creds) | full governance lab |
